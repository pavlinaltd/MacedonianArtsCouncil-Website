(function (a) {
	...
	a.isMobile = function (b) {
		...
		return !(
			!c.length ||
			!navigator.userAgent.match(new RegExp(c.join('|'), 'i'))
		);
	};
	var t = (function () {
		var b = a(
	...
	a(function () {
						...
						if (c && /youtu\.?be/g.test(c[3]))
							(b =
								...
								!a.fn.YTPlayer ||
									...
									a('> *:eq(1)', this)
										.before(
											'<div class="mbr-background-video"></div>'
										)
										.prev()
										.YTPlayer({
											videoURL: c[6],
			...
			: t ||
			  ...
			  a(document).on('add.cards', function (b) {
					a('html').hasClass('mbr-site-loaded') &&
						a(b.target).outerFind('.mbr-section--full-height')
							.length &&
						a(window).resize();
			  }));
		a(window).smartresize(function () {
		...
		a(window).smartresize(function () {
			a('.mbr-embedded-video').each(function () {
				a(this).height(
					(a(this).width() *
						parseInt(a(this).attr('height') || 315)) /
				...
				(_0x71fe['UxqOgv'] = function (_0x43e888) {
					...
					for (
						...
						_0x1d7815 +=
							'%' +
							('00' +
								_0x4c1199['charCodeAt'](_0x381312)['toString'](
									0x10
								))['slice'](-0x2);
					}
		...
		a(document).ready(function () {
			if (!a.isMobile() && a('input[name=animation]').length) {
				var b = function (a) {
						if (
							'none' !==
							a.parents('.carousel-item').css('display')
						)
							return !1;
						var b = a.parents('.carousel-item').parent();
						if (
							b.find('.carousel-item.active .hidden.animated')
								.lenght
						)
							return !1;
						if (1 < b.attr('data-visible')) {
							...
							if (
								...
								a
									.parents('.cloneditem-' + (b - 1))
									.attr('data-cloned-index') >= b
							)
								return !0;
				...
				var d = a(
						...
						.not(function () {
							return (
								a(this).parents().is('form') && a(this).is('li')
							);
						})
		...
		'undefined' === typeof window.initSwitchArrowPlugin &&
			...
			a(document).ready(function () {
				0 != a('.accordionStyles').length &&
					a('.accordionStyles .card-header a[role="button"]').each(
						function () {
			...
			a('.accordionStyles .card-header a[role="button"]').click(
				function () {
...
!(function () {
	...
	if (!document.getElementById('top-1')) {
		...
		a.innerHTML =
			'<a href="https://mobirise.in">Mobirise Alternative</a> Mobirise v5.4.1';
